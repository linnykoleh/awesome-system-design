...
- [TutorialSearch](https://tutorialsearch.io/browse/devops-it/system-reliability) - Free cross-platform search engine indexing 50,000+ tutorials from Udemy, Skillshare, Pluralsight, and other major learning platforms across 45+ categories.
...
9. **Messenger group** - [image](excalidraw/images/messenger-group.png) | [diagram](excalidraw/messenger-group.excalidraw)
10. **Rate limiter** - [image](excalidraw/images/rate-limiter.png) | [diagram](excalidraw/rate-limiter.excalidraw)
11. **Logging system** - [image](excalidraw/images/logging-system.png) | [diagram](excalidraw/logging-system.excalidraw)
12. **Live comments** - [image](excalidraw/images/live-comments.png) | [diagram](excalidraw/live-comments.excalidraw)
13. **Post search** - [image](excalidraw/images/post-search.png) | [diagram](excalidraw/post-search.excalidraw)
14. **Top K** - [image](excalidraw/images/top-k.png) | [diagram](excalidraw/top-k.excalidraw)
15. **Uber** - [image](excalidraw/images/uber.png) | [diagram](excalidraw/uber.excalidraw)
16. **YouTube** - [image](excalidraw/images/youtube.png) | [diagram](excalidraw/youtube.excalidraw)
17. **Web-crawler** - [image](excalidraw/images/web-crawler.png) | [diagram](excalidraw/web-crawler.excalidraw)
18. **Ad-click-aggregator** - [image](excalidraw/images/ad-click-aggregator.png) | [diagram](excalidraw/ad-click-aggregator.excalidraw)
19. **Miro** - [image](excalidraw/images/miro.png) | [diagram](excalidraw/miro.excalidraw)
20. **Google docs** - [image](excalidraw/images/google-docs.png) | [diagram](excalidraw/google-docs.excalidraw)
21. **Delete users data service** - [image](excalidraw/images/delete_users_data.png) | [diagram](excalidraw/delete_users_data.excalidraw)
22. **Instagram** - [image](excalidraw/images/instagram.png) | [diagram](excalidraw/instagram.excalidraw)
23. **ChatGPT** - [image](excalidraw/images/chatgpt.png) | [diagram](excalidraw/chatgpt.excalidraw)
24. **Job Scheduler** - [image](excalidraw/images/job-scheduler-service.png) | [diagram](excalidraw/job-scheduler-service.excalidraw)
25. **IP access control gateway** - [image](excalidraw/images/ip-access-control-gateway.png) | [diagram](excalidraw/ip-access-control-gateway.excalidraw)
26. **Distributed cache** - [image](excalidraw/images/distributed_cache.png) | [diagram](excalidraw/distributed_cache.excalidraw)
27. **Payment system** - [image](excalidraw/images/payment-system.png) | [diagram](excalidraw/payment-system.excalidraw)
28. **Metrics monitoring** - [image](excalidraw/images/metrics-monitoring.png) | [diagram](excalidraw/metrics-monitoring.excalidraw)
29. **News aggregator** - [image](excalidraw/images/news-aggregator.png) | [diagram](excalidraw/news-aggregator.excalidraw)
30. **Strava** - [image](excalidraw/images/strava.png) | [diagram](excalidraw/strava.excalidraw)
31. **Yelp** - [image](excalidraw/images/yelp.png) | [diagram](excalidraw/yelp.excalidraw)
32. **Online auction** - [image](excalidraw/images/online-auction.png) | [diagram](excalidraw/online-auction.excalidraw)
33. **Alert notification system** - [image](excalidraw/images/alert_notification_system.png) | [diagram](excalidraw/alert_notification_system.excalidraw)
34. **Online chess** - [image](excalidraw/images/online-chess.png) | [diagram](excalidraw/online-chess.excalidraw)
35. **McDonalds** - [image](excalidraw/images/mcdonalds.png) | [diagram](excalidraw/mcdonalds.excalidraw)
...
![29.png](images/system.design.10/29.png)
...
- `Requirements (3-5 min)`
    ...
    - `Ask interviewer what the Scale of the system will be`  
        - 1B users
        - 10M dau
        - 100k rps
        - 10k tps
    - `Non functional` (use **why** you used such NFR)
        - **Ask interviewer what the Scale of the system will be** 
        - **CAP Theorem**: Should your system prioritize `consistency` or `availability`? `Partition tolerance` is a given in distributed systems. 
          - Strong consistency
        ...
        - **Latency**: How quickly does the system need to respond to user requests? Specifically consider any requests that require meaningful computation. For example, low latency search when designing Yelp.
          - Rendering feeds in under 200ms
...
- `Follow-up (2–3 min)`
    - Bottlenecks
    - Scale
      - 1x → 10x: usually a config change. Bigger box, more replicas, tune the pool.
      - 10x → 100x: structural. Caching layer, read replicas, async processing, queues.
      - 100x → 1000x: topology. Sharding, regional partitioning, CDN, separate write/read systems entirely (CQRS).
      - 1000x+: different system. You probably need to rebuild the hot component on different primitives.
    - Failure Handling
      - Timeouts
      - Retries
        - exponential backoff
...
- `CP` (consistency) — reject requests rather than serve stale data. Banking, inventory, bookings.
- `AP` (availability) — serve a possibly stale response, reconcile later. Social feeds, DNS, shopping carts.
- Interview phrase: "For user profile updates I would prioritize consistency, but for feed generation eventual consistency is acceptable."

### 2. Strong vs Eventual Consistency

- `Strong` — every read sees the latest write. Simpler reasoning, higher latency, harder to scale. Use for: payments, auth, unique constraints.
- `Eventual` — replicas converge over time. Cheap, scales well, but reads may be stale. Use for: timelines, view counts, recommendations, DNS.

### 3. Latency vs Throughput

- `Low Latency` — time for a single request. Optimize with caching, CDN, fewer hops, smaller payloads.
  - Fast response
  - More resources
  - Smaller batches
- `High Throughput` — requests per second. Optimize with batching, async processing, parallelism.
  - More requests/sec
  - Better batching
  - Larger queues
- Batching and queuing trade latency for throughput. Real-time systems (chat, gaming) prioritize latency; data pipelines and analytics prioritize throughput.
- Example:
...
- `SQL` (relational) — ACID, joins, strong schema, mature tooling. Vertical scale by default; horizontal scale is painful. Use for: financial data, orders, anything relational, complex queries.
- `NoSQL` — flexible schema, built for horizontal scale, weaker consistency by default. Use for feeds, logs, analytics, massive scale, flexible schema
  - Key-value (Redis, DynamoDB) — fastest, dumbest queries
...
- Interview phrase: "I would choose PostgreSQL initially because consistency and transactional guarantees are more important than horizontal write scalability at this stage."

### 5. Vertical vs Horizontal Scaling

- `Vertical (scale up) `— bigger box. Simple, no code changes, hits a ceiling, single point of failure, expensive at the top end.
  - Bigger machine
  - Simpler
  - Hardware limits
  - Easier DB upgrades
- `Horizontal (scale out)` — more boxes. Effectively unlimited, fault-tolerant, but requires stateless services or sharding, plus orchestration and data partitioning logic.
  - More machines
  - More scalable
  - Distributed complexity
  - Sharding needed
- Most real systems start vertical and move horizontal when forced to.
- Interview answer: "Vertical scaling is usually the first step because it is operationally cheaper."

### 6. Normalization vs Denormalization

- `Normalized` — no duplication, easy writes, consistent updates, but joins on every read.
- `Denormalized` — duplicate data for fast single-table reads. Updates become writes to many places; risk of drift.
- Read-heavy workloads (feeds, profiles, dashboards) lean denormalized. OLTP leans normalized.
- Denormalization is common in distributed systems.
...
- `Microservices`  
  ...
  - Independent scaling
  - Team autonomy
  - Pays a heavy tax: distributed transactions, network failures, observability, service discovery, deployment complexity.
- Default to monolith. Split when team or load makes it hurt.

### 8. Synchronous vs Asynchronous

- `Synchronous` (REST/gRPC) — caller waits. Simple flow, immediate errors, but couples availability — slow downstream slows you.
- `Asynchronous` (queues, events) — fire and forget. Better throughput, isolates failures, analytics, background jobs, smooths load spikes. Adds complexity: eventual consistency, idempotency, retries, dead-letter queues.
- Use async for anything the user doesn't need to wait on: email, video transcoding, notifications, analytics.
- Interview phrase: "Critical user flows stay synchronous, heavy processing moves to async pipelines."

### 9. Push vs Pull

- `Push` (server → client / producer → consumer) — real-time, low latency, no wasted polls, but harder to handle slow consumers, needs persistent connections (WebSocket, SSE).
- `Pull` (client polls) — simple, client controls rate, but wasted requests and higher latency, polling.
- Hybrid: long polling, or push notifications with pull on reconnect.
- Example:
  - Chat → push
  - Metrics dashboards → pull

### 10. Batch vs Stream Processing

- `Batch` (Spark, Hadoop) — high throughput, simpler semantics, results delayed by the batch window. Use for: daily reports, ETL, model training.
- `Stream` (Flink, Kafka Streams) — low latency, continuous, harder to reason about (windowing, watermarks, late events). Use for: fraud detection, real-time dashboards, alerting.
- Example:
  - Night analytics → batch
  - Fraud detection → stream

### 11. Caching strategy

- `Read-through / cache-aside` — app fills cache on miss. Simple, but first request is slow; risk of stale data.
- `Write-through` — write to cache and DB together. Cache always freаsh; writes are slower.
- `Write-back (write-behind)` — write to cache, flush to DB async. Fast writes, risk of data loss on crash.
- `Write-around` — write straight to DB, skip cache. Good when written data is rarely read soon after.
- Invalidation strategy matters more than the algorithm — TTL, explicit invalidation, or versioning.

### 12. Replication: Single-Leader / Multi-Leader / Leaderless

- `Single-leader (primary-replica)` — easy to reason about, strong consistency on the leader, but leader is a bottleneck and SPOF until failover.
- `Multi-leader` — accepts writes in multiple regions, better write availability and locality. Conflict resolution is hard (last-write-wins loses data).
- `Leaderless` (Dynamo-style — Cassandra, Riak) — any node accepts writes, quorum reads/writes (R + W > N). Highly available, eventual consistency, conflict resolution via vector clocks or app logic.

### 13. Sharding Strategies

- `Range-based` — easy range queries, but risks hotspots (sequential IDs all hit the latest shard).
- `Hash-based` — even distribution, terrible for range queries.
- `Consistent hashing` — minimizes resharding when nodes are added/removed. Standard for distributed caches and Dynamo-style stores.
- `Directory/lookup-based` — flexible, but the lookup service becomes a SPOF.

### 14. REST vs gRPC vs GraphQL

- `REST` — ubiquitous, cacheable, human-readable, but verbose and prone to over/under-fetching.
- `gRPC` — binary, fast, strongly typed (protobuf), streaming. Worse browser support, harder debugging, tight coupling on schema versions. Great for internal service-to-service.
- `GraphQL` — client picks exactly what it needs; one endpoint. Solves over-fetching but moves complexity to the server (resolvers, N+1, caching, rate limiting).

### 15. Load Balancing: L4 vs L7

- `L4 (TCP)` — fast, simple, protocol-agnostic. Can't make routing decisions based on content.
- `L7 (HTTP)` — routes by path, header, cookie. Enables canaries, A/B, sticky sessions. Higher CPU cost, must terminate TLS.

### 16. Stateful vs Stateless Services

- `Stateless` — any instance handles any request. Trivial to scale and replace. Push state to DB, cache, or client.
- `Stateful` — instance holds session/connection state (WebSocket servers, game servers). Harder to scale, needs sticky sessions or state replication.- 
- Default to stateless. State belongs in dedicated storage.

### 17. Optimistic vs Pessimistic Locking

- `Optimistic` (version numbers, CAS) — assume conflicts are rare, detect on write, retry on conflict. Great for low-contention workloads.
- `Pessimistic` (row locks, distributed locks) — acquire lock before changes. Safer under contention, but risks deadlocks and reduces throughput.

### 18. Message Delivery Guarantees

- `At-most-once` — fast, may drop messages. Use for: metrics, logs where loss is acceptable.
- `At-least-once` — never lost, may be duplicated. Requires idempotent consumers. Default for most systems.
- `Exactly-once` — hard, expensive, often a marketing claim. Achievable end-to-end with transactional outbox + idempotency keys.

---

## System Design Interview Cheat Sheet

### Architecture, Tradeoffs, Scalability

#### Opening / Clarification

- “Before we go ahead, I have a few clarifying questions I’d like to ask.”
- “Does that sound OK?”
- “I’m going to take a few seconds to think about that, if that’s OK with you.”
- “I want to first clarify the functional and non-functional requirements.”
- “From a user experience perspective…”
- “I will come back to it after satisfying all functional requirements.”

#### High-Level Design

- “High-level design is in place, now let’s go deeper.”
- “The simplest solution would be…”
- “The most practical approach is…”
- “I would initially optimize for simplicity.”
- “At this scale I would avoid premature optimization.”
- “We can evolve this architecture once bottlenecks appear.”
- “It’s overkill here.”
- “I was intentionally vague about it.”
...
- “The bottleneck usually appears when…”
- “At high load…”
- “The main concern here becomes coordination in distributed systems.”
- “Partitioning strategy is one of the most important long-term architectural decisions.”
- “Perfectly even traffic distribution rarely exists in real systems.”
- “This becomes expensive under heavy concurrency.”

#### Databases

- “The most expensive part is the database, this is a bottleneck.”
...
- “Replication improves reads, but not write scalability.”
...
- “This introduces eventual consistency, so idempotency becomes important.”

#### Tradeoffs

- “The main trade-off is…”
- “This is a tradeoff between operational complexity and scalability.”
- “This approach improves scalability because…”
- “I’m choosing eventual consistency here.”
- “The tradeoff is that the like count can be stale for a few seconds, but we get significantly cheaper reads and survive replica failures.”
- “For likes, that’s acceptable. For payments, it wouldn’t be.”
- “Maybe this is a problem, maybe not, we need to discuss it with the product manager.”

### Senior-Level Phrases, Experience, Confidence

#### Senior-Level Architecture Phrases

- “We need to fix the root problem.”
- “The core problem is…”
- “The key point is…”
- “The important part here is…”
- “This solution sucks at this problem for two concrete reasons.”
- “The biggest operational challenge here is…”
- “The main complexity comes from distributed coordination.”
- “This is where eventual consistency starts to matter.”
- “This architecture optimizes for read-heavy workloads.”
- “This architecture optimizes for write throughput.”
- “This is a classic latency vs consistency tradeoff.”
- “We should also consider GDPR and data retention policies, but I’ll keep them out of scope for now and focus on scalability.”
...
- “The hot partition problem becomes visible when…”
- “This endpoint is likely to become CPU-bound.”
- “This component is network-bound rather than compute-bound.”
- “The write path is usually more expensive than the read path.”
- “This optimization only makes sense at scale.”
- “I would avoid introducing operational complexity too early.”

#### Production Experience

- “In production we solved this by…”
- “One issue we faced was…”
- “What worked well for us…”
- “We observed that…”
- “In distributed systems this often leads to…”
- “One common production issue is retry storms.”
- “We had to introduce backpressure because…”
- “We solved this using asynchronous processing.”
- “Idempotency became critical once retries were introduced.”
- “One thing we learned in production is that metrics and observability are essential.”

### Confidence / Communication

- “Let me structure my thoughts first.”
- “I’ll start simple and evolve the design gradually.”
- “I’ll first design for correctness, then optimize for scale.”
- “I’ll make a few assumptions to move faster.”
- “I’ll explicitly call out tradeoffs as we go.”
- “I’ll prioritize reliability and operational simplicity first.”
- “The simplest working solution is usually the best starting point.”
- “I’d like to discuss alternative approaches as well.”
- “This depends heavily on product requirements and traffic patterns.”

#### Emergency Fallback Phrases

- “I would validate this assumption with real production metrics.”
- “At this point I would benchmark both approaches.”
- “Without concrete traffic numbers, I’d avoid over-engineering.”
- “This depends on read/write ratio.”
- “The final decision depends on consistency requirements.”
- “This is a business tradeoff as much as a technical one.”
- “I would revisit this decision once the system reaches scale.”
...
- Solutions:
  ...
  - denormalization
  - batching
- Senior signal: "At moderate scale the database usually becomes the first bottleneck."

### Network bottleneck

- Problems:
  - Every service waits on another service.
    - API → User Service → Auth Service → Billing Service → Recommendation Service
  - bandwidth between regions
  - One slow service slows entire request chain.
- Solutions:
  - caching
  - async processing
  - parallel calls
...
-  IOPS limits on cloud volumes, log writes, fsync cost.

### Hot Partitions bottleneck

- Very common in distributed systems.
- Example:
  - all traffic goes to one Kafka partition
  - celebrity user
  - single Redis key
...
- Solutions:
  - better partition key
    - hash(userId)
  - consistent hashing
    - many virtual partitions per node
  - Replication of Hot Data
  - Adaptive Load Balancing
  - Randomized Sharding
    - Instead of: user:123
    - Use: user:123:1, user:123:2, user:123:3
    - Tradeoff
      - writes scale better
      - reads become more expensive
  - Celebrity profile cache on:
    - CDN
    - Redis
    - local memory cache

### Cache Miss Storm bottleneck
...
- For example, if a client establishes a TCP connection through an L4 load balancer, that same server will handle all subsequent requests within that TCP session. 
- This makes L4 load balancers particularly well-suited for protocols that require persistent connections, like WebSocket connections. 
...
0 While L7 load balancers can help us to not have to worry about lower-level details like TCP connections, we aren't able to ignore the connection-level reality if we want persistent connections to consistent servers.
...
![35.png](images/system.design.10/35.png)
...
- `Polling`
  - The simplest possible approach is to have the client regularly poll the server for updates
- `Long Polling`
    - The client makes a request to the server and the server holds the request open until new data is available. 
    - It's as if the server is just taking really long to process the request. 
    - The server then responds with the data, finalizes the HTTP requests, and the client immediately makes a new HTTP request.
- `Server-Sent Events (SSE)`
  - SSE is an extension on long-polling that allows the server to send a stream of data to the client.
  - With SSE, instead of sending a full response once data becomes available, the server sends a chunk of data and then keeps the request open to send more data as needed. 
  - SSE is perfect for scenarios where servers need to push data to clients, but clients don't need to send data back frequently.
- `Websockets`
  - WebSockets are the go-to choice for true bi-directional communication between client and server. 
  - If you have high frequency writes and reads, WebSockets are the champ.
- `WebRTC Peer-to-Peer`
...
![30.png](images/system.design.10/30.png)

#### Server-Server push/pull

- `Pulling with Simple Polling`
  - Asking the server for updates and the server needs to maintain the state necessary to respond to those requests
- `Pushing via Consistent Hashes`
  - Consistent hashing is ideal when you need to maintain persistent connections (WebSocket/SSE) and your system needs to scale dynamically. 
  - It's particularly valuable when each connection requires significant server-side state that would be expensive to rebuild. 
  - Requires coordination service (like Zookeeper)
    - Any central registration service may become a bottleneck
- `Pushing via Pub/Sub`
  - When clients connect, we don't need them to connect to a specific endpoint server and instead can connect to any of them. 
  - Once connected, the endpoint server will register the client with the pub/sub server so that any updates can be sent to them.
  ...
  - Popular options here include Kafka and Redis.
...
- The `WHERE` clause is just how SQL spells `compare-and-set`, the same move `DynamoDB` makes with a `ConditionExpression`, `Redis` with `SET NX`, `Cassandra` with a lightweight transaction, or an `HTTP API` with an `If-Match header`
- Below are atomic operations enought `READ COMMITTED` isolation level with row blocking
...
- Row locks
  - The `lock` in this context is a mechanism that prevents other database connections from accessing the same data until the lock is released. 
  - Databases like `PostgreSQL` and `MySQL` can handle thousands of concurrent connections, but locks ensure that only one connection can modify a specific row (or set of rows) at a time.
- Pessimistic locking prevents conflicts by acquiring locks upfront
- The `FOR UPDATE` clause locks every row the `SELECT` returns
- While you pick a block, no other transaction can claim those seats, so a second group running the same query waits until you commit
...
![31.png](images/system.design.10/31.png)

### Optimistic Concurrency Control

- It assumes conflicts are rare and detects them after the fact instead of blocking to prevent them
- Under low contention, that skips the locking overhead entirely.
- You need one value in the row that's guaranteed to change every time the row is written.
- Version number, and the most common form is a dedicated integer you bump by one on every write
...
![32.png](images/system.design.10/32.png)

### Distributed Locks

#### Redis with TTL 

- Redis gives you atomic operations with automatic expiration, which makes it a great fit for a reservation lock. 
- The `SET` command with `NX` (only set if not exists) and a `TTL` atomically creates a lock that Redis clears on its own when the `TTL` passes (the NX flag is critical, without it a second process could overwrite an existing lock).
- No cleanup job, and any web server can check the same key

#### Database columns

- Lock is just two columns on the row, one for who holds it and one for when the hold expires
- The advantage is no new infrastructure and the same consistency as the rest of your data. 
- The disadvantage is that database writes are slower than a cache, and the lock row itself becomes a contention point under heavy load.
...
- Uses consensus algorithms (ZAB/Raft) for strong consistency, making them robust for complex failure scenarios at the cost of operational complexity.

### Coordination multiple processes (The Saga Pattern)

- Saga is a sequence of local steps where each step has a matching compensating action that undoes it.
- You run the steps one at a time, and if a later one fails, you walk backwards firing those compensations to unwind whatever already happened.
...
- Each worker subscribes to the events it cares about, does its piece, and emits new events for the next worker to react to.
- Choreography works great for fully independent services and for mid-complexity workflows.

![33.png](images/system.design.10/33.png)

#### Orchestration

- Where a single coordinator owns the flow and tells workers what to do.
- Because the whole sequence lives in one place, orchestration works best for very complex workflows where you need central control and visibility.

![34.png](images/system.design.10/34.png)
...
- Read Replicas
- Database Sharding
  - Vertical partitioning (Post, User, Likes)
  - Horizontal partitioning (By records)
  - Geographic sharding
    - Particularly effective for global read scaling. 
    - Store US user data in US databases, European data in European databases. 
    - Users get faster reads from nearby servers while reducing load on any single database.

#### Add external caching layers

- Application-Level Caching
  - In-memory caches like Redis or Memcached sit between your application and database.
...
- Database Choices
  - `Cassandra`
    - Write-heavy database (10,000+ writes per second)
    - Read performance isn't great - reading data often requires checking multiple files and merging results, which can be slower than a well-indexed relational database
  - Time-series databases like `InfluxDB` or `TimescaleDB` are built for high-volume sequential writes with timestamps
...
- **Horizontal** Sharding
  - The most important detail you'll want to share is how to select a partitioning key.
  - The principle here is that we want to select a key that minimizes variance in the number of writes per shard or, in the visual above, flat is good.
...
- Write **Queues** for Burst Handling
  - Queues are only a temporary solution, if the app server continues to write to the queue faster than records can be written to the database, we get unbounded growth of our queue. 
...
![38.png](images/system.design.10/38.png)

- **Load Shedding** Strategies
  - A simple solution here is to simply drop the least useful writes during times of system overload 
  - For Uber these might be location updates that are within seconds of a previous update. 
  - For an analytics system, we might drop impressions for a while to ensure we can process the more important clicks.

![39.png](images/system.design.10/39.png)

#### Batching and Hierarchical Aggregation

- **Batching**
  - Application Layer
      - If we have a service reading from a Kafka topic, performing some processing, and then writing to the database, we can batch up the writes together before we send them to the database
      - If the application crashes, we'll have to re-read the Kafka topic to recover but we haven't lost data.
  - Intermediate Processing
      - have an intermediate process which batches up writes before they are sent to the database.

![41.png](images/system.design.10/41.png)

  - Database Layer
      - Most database systems have configurable options for how often writes are flushed to disk, the bottleneck for most systems.
      - Redis' default configuration is to flush writes to disk every 100ms

![40.png](images/system.design.10/40.png)

- **Hierarchical Aggregation**
    - By aggregating the data with the write processors and dis-aggregating it with the broadcast nodes, we've substantially reduced the number of writes that any one system needs to handle at the cost of some latency introduced by adding steps. 
    - And that's the heart of hierarchical aggregation!

![42.png](images/system.design.10/42.png)
...
- When users submit heavy tasks (like video encoding), the web server instantly validates the request, pushes a job to a queue (Redis/RabbitMQ), and returns a job ID, all within milliseconds. 
- Meanwhile, separate worker processes continuously poll the queue, grab pending jobs, execute the actual time-consuming work, and update the job status in a database.

![43.png](images/system.design.10/43.png)

#### Common system for Long Running Tasks 
...
![44.png](images/system.design.10/44.png)
